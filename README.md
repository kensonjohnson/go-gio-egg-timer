# Egg Timer with Go and Gio

This is result of following [this tutorial](https://jonegil.github.io/gui-with-gio/egg_timer/).
...
```sh
git clone git@github.com:kensonjohnson/go-gio-egg-timer.git
cd go-gio-egg-timer
```
